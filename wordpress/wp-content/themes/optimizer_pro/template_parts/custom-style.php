...
/*-----------------------------COLORS------------------------------------*/
		...
		body.header_sidebar.home #topmenu ul li a{color:<?php echo $optimizer['menutxt_color_id'] ?>;}
...
<?php if($optimizer['sec_color_id']){ ?>
		...
		.hover_colorbg .midrow_block:before, .hover_colorbg .midrow_block:hover .block_content, .hover_colorbg .midrow_block:hover h2, .hover_colorbg .midrow_block:hover h3, .hover_colorbg .midrow_block:hover h4, .hover_colorbg .midrow_block:hover a, .contact_form_wrap .contact_button, .contact_buttn_spinner{color:<?php echo $optimizer['sectxt_color_id']; ?>!important;}		
...
<?php if ( class_exists( 'WooCommerce' )){ ?>
	...
	.shop_bttn_rounded_hollow #respond input#submit:hover, .shop_bttn_rounded_hollow a.button:hover, .shop_bttn_rounded_hollow button.button:hover, .shop_bttn_rounded_hollow input.button:hover, .shop_bttn_rounded_hollow button.button.alt:hover, .shop_bttn_square_hollow #respond input#submit:hover, .shop_bttn_square_hollow a.button:hover, .shop_bttn_square_hollow button.button:hover, .shop_bttn_square_hollow input.button:hover, .shop_bttn_square_hollow button.button.alt:hover, .shop_bttn_circular_hollow #respond input#submit:hover, .shop_bttn_circular_hollow a.button:hover, .shop_bttn_circular_hollow button.button:hover, .shop_bttn_circular_hollow input.button:hover, .shop_bttn_circular_hollow button.button.alt:hover, .shop_bttn_rounded_hollow .widget_product_search input[type="submit"]:hover, .shop_bttn_square_hollow .widget_product_search input[type="submit"]:hover, .shop_bttn_circular_hollow .widget_product_search input[type="submit"]:hover, .optimposts .type-product a.button.add_to_cart_button:hover{background-color:<?php echo $optimizer['woo_prim_color']; ?>;color:#fff; border-color:transparent;}

	.optimposts .lay4_wrap .type-product a.button.add_to_cart_button:hover, .optimposts .lay5_wrap .type-product a.button.add_to_cart_button:hover, .archive.shop_bttn_circular_hollow ul.products li.product .button:hover, .archive.shop_bttn_rounded_hollow ul.products li.product .button:hover:hover, .archive.shop_bttn_square_hollow ul.products li.product .button:hover, .optimposts .type-product a.button.add_to_cart_button:hover, .archive.woocommerce-page ul.products li.product a.button.add_to_cart_button:hover, .has_woo_shortcode ul.products li.product a.button.add_to_cart_button:hover{background-color:<?php echo $optimizer['woo_prim_color']; ?>!important;color:#fff; border-color:transparent;}
	...
	/*Sale Color*/
	.woocommerce span.onsale, .optimposts .type-product span.onsale, .woo-slider #post_slider li.sale .woo_sale, #optimizer_minicart_wrap a.button.wc-forward{background-color:<?php echo $optimizer['woo_sale_color']; ?>;color:#fff;}
	...
	#topmenu #optimizer_minicart{background-color:<?php echo $optimizer['head_color_id']; ?>}
