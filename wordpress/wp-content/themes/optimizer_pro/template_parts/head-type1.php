...
<!--HEADER STARTS-->
    <div class="header <?php echo $optimizer['logo_position']; ?> has_mobile_<?php echo $optimizer['mobile_menu_type']; ?>" <?php optimizer_schema_item_type('header'); ?>>
    
    
    <!--TOP HEADER-->
    <?php if (!empty ($optimizer['tophead_id']) || is_customize_preview()) { ?>
    
    <div class="head_top<?php if (!empty ($optimizer['topsearch_id'])) { ?> headsearch_on<?php } ?><?php if (empty ($optimizer['topmenu_switch'])) { ?> topmenu_switch<?php } ?> <?php if (!empty ($optimizer['tophone_id'])) { ?>tophone_on<?php } ?> <?php if (empty ($optimizer['tophead_id'])) { ?>hide_topbar<?php } ?><?php if (empty ($optimizer['topmenu_id'])) { ?>hide_topmenu<?php } ?>">
        ...
        <div class="center">
        	<?php if ($optimizer['logo_position'] == 'topbarlogo' || is_customize_preview()) { ?>
            	...
            	<div class="logo <?php echo $hidelogo.' '.$hidedesc; ?>">
                    <?php if(!empty($optimizer['home_logo_id']['url']) && is_home()  ){   ?>
