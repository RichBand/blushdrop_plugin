...
<div class="post_wrap layer_wrapper">
    ...
    <?php } ?>
		...
		<div class="center">
           <!--POST START-->
			<div class="single_wrap<?php $hide_sidebar = get_post_meta( $post->ID, 'hide_sidebar', true); if (!empty($hide_sidebar ) || !is_active_sidebar( 'sidebar' )) { ?> no_sidebar<?php } ?>" <?php optimizer_schema_item_type('post'); ?>>
