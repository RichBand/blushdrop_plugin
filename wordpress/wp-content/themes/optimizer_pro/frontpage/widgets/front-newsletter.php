...
class optimizer_front_Newsletter extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		if(is_customize_preview()){
			...
			echo '<style>#'.$id.'{ ' . $content_bg . '' . $content_bgimg . '}#'.$id.' .newsletter_content, #'.$id.' .optim_newsletter_form, #'.$id.' .optim_newsletter_form input, #'.$id.' .optim_newsletter_form .ctct-embed-signup >div{' . $content_color . '}#'.$id.' .optim_newsletter_form .button, #'.$id.' .optim_newsletter_form input[type="button"], #'.$id.' .optim_newsletter_form input[type="submit"], #'.$id.' .optim_newsletter_form button{' . $button_bg . '' . $button_color . '}</style>';
		}
...
<?php
		...
		if(!is_customize_preview()){
			...
			foreach ( $settings as $instance_id => $instance ) {
				...
				$widget_style = '#'.$id.'{ ' . $content_bg . '' . $content_bgimg . '}#'.$id.' .newsletter_content, #'.$id.' .optim_newsletter_form, #'.$id.' .optim_newsletter_form .ctct-embed-signup >div{' . $content_color . '}#'.$id.' .optim_newsletter_form .button, #'.$id.' .optim_newsletter_form input[type="button"], #'.$id.' .optim_newsletter_form input[type="submit"], #'.$id.' .optim_newsletter_form button{' . $button_bg . '' . $button_color . '}';
