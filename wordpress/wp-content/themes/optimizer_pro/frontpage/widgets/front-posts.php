...
class optimizer_front_Posts extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		<div class="lay'.$layout.' optimposts" data-post-layout="'.$layout.'" data-post-type="'.$type.'" data-post-count="'.$count.'" data-post-category="'.$blogcats.'" data-product-category="'.$prodcats.'" data-post-pages="'.$widgetpages.'" data-post-previewbtn="'.$previewbtn.'" data-post-linkbtn="'.$linkbtn.'" data-post-navigation="'.$navigation.'">
		<div class="center">';
			...
			//Call the Posts
			optimizer_posts($layout, $type, $count, $category, $product_category, $pages, $previewbtn , $linkbtn, $navigation);
