        ...
        <?php get_template_part('customizer/widget','presets'); ?>
            ...
            <ol id="optimizerTour">
              ...
              <li>
              	...
              	<p><?php _e('That\'s all! We Hope you like the Theme :) If you have any support questions related to the theme please be sure to post them on <a target="_blank" href="https://optimizerwp.com/get-support/">Optimizer Support Forum.', 'optimizer'); ?></a></p>
