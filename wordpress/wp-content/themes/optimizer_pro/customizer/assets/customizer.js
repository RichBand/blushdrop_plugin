...
/*	setTimeout(function(){		
	...
	jQuery('.widget_advanced.advanced_widget_toggle_off h4').live('click',function(){ 
	 ...
	 jQuery('.widget_advanced.advanced_widget_toggle_on h4').live('click',function(){ 
...
jQuery(window).bind('load', function(){
	...
	jQuery('#available-widgets-list [id^="widget-tpl-optimizer_front_about"]').attr('data-order','1');
	jQuery('#available-widgets-list [id^="widget-tpl-optimizer_front_text"]').attr('data-order','2');
	jQuery('#available-widgets-list [id^="widget-tpl-optimizer_front_blocks"]').attr('data-order','3');
	jQuery('#available-widgets-list [id^="widget-tpl-optimizer_front_posts"]').attr('data-order','4');
	jQuery('#available-widgets-list [id^="widget-tpl-optimizer_front_video"]').attr('data-order','5');
	jQuery('#available-widgets-list [id^="widget-tpl-optimizer_front_carousel"]').attr('data-order','6');
	jQuery('#available-widgets-list [id^="widget-tpl-optimizer_front_slider"]').attr('data-order','7');
	jQuery('#available-widgets-list [id^="widget-tpl-optimizer_front_portfoio"]').attr('data-order','8');
	jQuery('#available-widgets-list [id^="widget-tpl-optimizer_front_map"]').attr('data-order','9');
	jQuery('#available-widgets-list [id^="widget-tpl-optimizer_front_newsletter"]').attr('data-order','10');
	jQuery('#available-widgets-list [id^="widget-tpl-optimizer_front_cta"]').attr('data-order','11');
	jQuery('#available-widgets-list [id^="widget-tpl-optimizer_front_testimonials"]').attr('data-order','12');
	jQuery('#available-widgets-list [id^="widget-tpl-optimizer_front_clients"]').attr('data-order','13');
	jQuery('#available-widgets-list [id^="widget-tpl-ast_countdown_widget"]').attr('data-order','14');
	jQuery('#available-widgets-list [id^="widget-tpl-ast_scoial_widget"]').attr('data-order','15');
