...
if ( ! function_exists( 'optimizer_fonts_editor' ) ) {
	function optimizer_fonts_editor( $initArray ) {
		...
		if(!empty($optimizer['ptitle_font_id']['font-family'])){ $title_font = $optimizer['ptitle_font_id']['font-family'];}else{ $title_font =''; }
		if(!empty($optimizer['logo_font_id']['font-family'])){ $logo_font = $optimizer['logo_font_id']['font-family'];}else{ $logo_font =''; }
	    ...
	    $initArray['font_formats'] = ''.$title_font.'='.$title_font.';'.$logo_font.'='.$logo_font.';*'.$custom_font.'='.$custom_font.';'.'Lato=Lato;Andale Mono=andale mono,times;Arial=arial,helvetica,sans-serif;Arial Black=arial black,avant garde;Book Antiqua=book antiqua,palatino;Comic Sans MS=comic sans ms,sans-serif;Courier New=courier new,courier;Georgia=georgia,palatino;Helvetica=helvetica;Impact=impact,chicago;Symbol=symbol;Tahoma=tahoma,arial,helvetica,sans-serif;Terminal=terminal,monaco;Times New Roman=times new roman,times;Trebuchet MS=trebuchet ms,geneva;Verdana=verdana,geneva;Webdings=webdings;Wingdings=wingdings,zapf dingbats';
            return $initArray;
	}
}
