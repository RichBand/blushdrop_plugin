...
if(!function_exists( 'optimizer_send_message' ) ){
	function optimizer_send_message($to) {
			...
			if (isset($_POST['contact_message'])) {
				...
				if (isset($_POST['contact_extra'])) {$extra_field = ' / '.$_POST['contact_extra']; }else{$extra_field = '';}
				
				
				ob_start();
					echo '<p style="border-bottom: 1px solid #DADADA;padding-bottom: 15px;"><b>From:</b> '.$_POST['contact_name'].' / '.$_POST['contact_email'].''.$extra_field.' <br></p>';
