    ...
    <div class="mdl-grid">
        <div class="bdp-leftBlock <?=mdlGrid(8,6,4)?>">
            <div class="mdl-grid mdl-grid--nested">
                ...
                <div id="selectedSongName" class="<?= mdlGrid(8,2,4, 'mdl-cell--middle')?> text-left"></div>
                ...
                <div id="audioWrapper" class="<?= mdlGrid( 12, 8, 4,'mdl-grid mdl-grid--nested mdl-cell--middle')?> ">
                    <div id="interface--info" class="<?= mdlGrid()?>" >
                        ...
                        <div id="info__title_artist" class="inlineFloatLeft cellTight text-left <?= mdlGrid(8,4,4, 'mdl-cell--middle')?>" >
                            <span id="info__title"></span>
                            (<span id="info__artist"></span>)
                        </div>
                        <div class="inlineFloatLeft cellTight text-left <?= mdlGrid(8,4,4, 'mdl-cell--middle')?>" >
                            <label for="eleCheckboxPlayer" class="mdl-checkbox mdl-js-checkbox mdl-js-ripple-effect">
                                Select this
                                <input type="checkbox" id="eleCheckboxPlayer" class="mdl-checkbox__input" <?= (($theresMusicInCart)? '' :' checked disabled') ?> />
                            </label>
                        </div>
                        <div id="audioControllers" class="inlineFloatLeft cellTight <?= mdlGrid(8,4,4, 'mdl-cell--middle')?>">
